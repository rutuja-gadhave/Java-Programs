...
class magicsqu extends Frame  implements ActionListener,ItemListener
{
	...
	magicsqu()
	{
		...
		t7.setBounds(180,280,50,50);
		t8.setBounds(230,280,50,50);	
		t9.setBounds(280,280,50,50);
		...
		l7.setBounds(180,240,50,50);
		l8.setBounds(230,240,50,50);
		l9.setBounds(280,240,50,50);
...
public void itemStateChanged(ItemEvent e)
		{
			...
			t7.setText(l1.getSelectedItem());
			t8.setText(l1.getSelectedItem());
			t9.setText(l1.getSelectedItem());
